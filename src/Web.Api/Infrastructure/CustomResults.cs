...
public static class CustomResults
{
    public static IResult Problem(Result result)
    {
        ...
        static string GetTitle(Error error) => error.Type switch
        {
            ...
            ErrorType.AlreadyExists => error.Code,
            _ => "Server failure"
        };
        ...
        static string GetDetail(Error error) => error.Type switch
        {
            ...
            ErrorType.AlreadyExists => error.Description,
        ...
        static string GetType(ErrorType errorType) => errorType switch
        {
            ...
            ErrorType.Failure => "https://datatracker.ietf.org/doc/html/rfc7231#section-4.2.2",
            ErrorType.Problem => "https://tools.ietf.org/html/rfc7231#section-6.5.1",
            ErrorType.NotFound => "https://tools.ietf.org/html/rfc7231#section-6.5.4",
            ErrorType.Conflict => "https://tools.ietf.org/html/rfc7231#section-6.5.8",
            ErrorType.AlreadyExists => "https://tools.ietf.org/html/rfc7231#section-6.5.8",
        ...
        static int GetStatusCode(ErrorType errorType) => errorType switch
        {
            ...
            ErrorType.Conflict or ErrorType.AlreadyExists => StatusCodes.Status409Conflict,
