...
public record GetSubscriptionWithPaginationQuery : IRequest<PaginatedList<SubscriptionDto>>
{
...
public class GetSubscriptionWithPagination (IApplicationDbContext context, IMapper mapper) : IRequestHandler<GetSubscriptionWithPaginationQuery,
