    ...
    ILogger<DataSeeder> logger, IKeycloakRolesService _keycloakRolesService)
{
    ...
    private async Task SeedSchoolModules(CancellationToken cancellationToken)
    {
        var modulesToSeed = new List<SchoolModule>
        {
            ...
            new() { Name = "School Settings", Key = "SCHOOL_SETTINGS", Description = "Configure school-level settings and preferences." },
            new() { Name = "User Profile", Key = "USER_PROFILE", Description = "Manage user profiles and account details." },
            new() { Name = "Notifications", Key = "NOTIFICATIONS", Description = "Configure and view system notifications." },
            new() { Name = "Academic Session", Key = "ACADEMIC_SESSION", Description = "Manage academic sessions and terms." },
            new() { Name = "Class Management", Key = "CLASS_MANAGEMENT", Description = "Manage classrooms and class assignments." },
            new() { Name = "Student Management", Key = "STUDENT_MANAGEMENT", Description = "Manage student profiles and enrollment data." },
            new() { Name = "Attendance", Key = "ATTENDANCE", Description = "Track student attendance and generate reports." },
            new() { Name = "Teacher Management", Key = "TEACHER_MANAGEMENT", Description = "Manage teachers and teacher records." },
            new() { Name = "Staff Management", Key = "STAFF_MANAGEMENT", Description = "Manage non-teaching staff and roles." },
            new() { Name = "Parent Management", Key = "PARENT_MANAGEMENT", Description = "Manage parent accounts and linked students." },
            new() { Name = "Subject Management", Key = "SUBJECT_MANAGEMENT", Description = "Create and maintain subjects and curricula." },
            new() { Name = "Results", Key = "RESULTS", Description = "Manage grading, results and report generation." },
            new() { Name = "Examinations", Key = "EXAMINATIONS", Description = "Manage exams, schedules and invigilation." },
            ...
            new() { Name = "Communication", Key = "COMMUNICATION", Description = "Manage messaging, announcements and communication channels." },
            new() { Name = "Role Management", Key = "ROLE_MANAGEMENT", Description = "Manage roles and permission assignments." }
        };
